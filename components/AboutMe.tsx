...
function AboutMe() {
  return (
    <section className='mx-20 px-8 py-section flex items-center mb-1 max-sm:flex-col max-sm:px-4 max-sm:mx-0'>
      <Image
        src='/about-me.svg'
        alt='about-me'
        width={518}
        height={592}
      />
      <div className='pl-[5.478rem] h-fit pb-11 max-sm:pl-0'>
        <h1 className='text-5xl text-left py-5 max-sm:text-[1.75rem]/8'>About <span className='font-extrabold'>Me</span></h1>
