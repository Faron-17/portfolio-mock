...
function Hero() {
  return (
    <section className='px-20 py-section max-sm:px-4'>
      <div className='px-8 flex max-sm:flex-col-reverse max-sm:px-0'>
        <div className='pt-[7.938rem] max-sm:pt-12'>
          <div className='pt-5 tracking-tight text-5xl/14 max-sm:pt-0 max-sm:text-[1.75rem]/8'>
          ...
          <ul className='pt-12 flex gap-8 max-sm:pt-0'>
